...
if __name__ == "__main__":
    ...
    parser.add_argument('--cluster_id', type=str, help = "the id for the cluster", default='clusterid')
    parser.add_argument('--shard_id', type=str, help = "the id for the shard",default='shardid')
